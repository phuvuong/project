      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form method="POST" action="{{ route('save-brand') }}" id="brand-form" enctype="multipart/form-data"> 
              @csrf
               @error('msg')
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Slug</label>
                     <input type="text" name="brand_slug" class="form-control" id="convert_slug" placeholder="Slug"placeholder="Slug thương hiệu">
                    @error('brand_slug')
              ...
              <div class="card-footer">
                <button type="submit"   class="btn btn-info add-brand">Thêm thương hiệu</button>
              </div>
            </form>
          </div>
