    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="{{ URL::to('/danh-muc-san-pham/'.$cate->category_id) }}">
                    ...
                    <div class="cat-item d-flex align-items-center mb-4">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>{{ $cate->category_name }}</h6>
                          
                           
                            <small class="text-body">{{count($product->where('category_id',$cate->category_id)) }} Sản phẩm</small>
        ...
        $(document).ready(function(){
            $('.add-to-cart').click(function(){
                ...
                if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                    swal("Warning!", "Làm ơn đặt nhỏ hơn " + cart_product_quantity + " sản phẩm!", "warning")
                }else{
                    $.ajax({
                        url: '{{url('/add-cart')}}',
                        method: 'POST',
