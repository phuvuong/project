                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>Email</label>
                            <input class="form-control" type="text" name="email_account" placeholder="Email">
                            
                        </div>
                        <div class="col-md-12 form-group">
                            <label>Password</label>
                            <input class="form-control" type="password" name="password_account" placeholder="Password">
                        </div>
                        <div class="col-md-12 form-group">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input class="form-control" type="text" name="customer_name" placeholder="Full Name">
                            @error('customer_name')
                        <span style="color:red;" class="customer_name_error">{{ $message }}</span>
                    @enderror
                        </div>
                        <div class="col-md-12 form-group">
                            <label>Email</label>
                            <input class="form-control" name="customer_email" type="text" placeholder="Email">
                            @error('customer_email')
                        <span style="color:red;" class="customer_email_error">{{ $message }}</span>
                        @enderror
                        </div>
                        <div class="col-md-12 form-group">
                            <label>Password</label>
                            <input class="form-control" name="customer_password" type="password" placeholder="Password">
                            @error('customer_password')
                        <span style="color:red;" class="customer_password_error">{{ $message }}</span>
                         @enderror
                        </div>
                        <div class="col-md-12 form-group">
                            <label>PhoneNumber</label>
                            <input class="form-control" name="customer_phone" type="text" placeholder="PhoneNumber">
                            @error('customer_phone')
                        <span style="color:red;" class="customer_phone_error">{{ $message }}</span>
                        @enderror
                        </div>
