        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{URL::to('uploads/backend/product/'.$value->product_image)}}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">{{number_format( $value->product_price).'VND' }} </h3>
                    <p class="mb-4">Danh mục: {{ $value->category_name }}</p>
                    <p class="mb-4">Thương hiệu: {{ $value->brand_name }}</p>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="number" name="qty" min="1" class="form-control bg-secondary border-0 text-center cart_product_qty_{{$value->product_id}}" value="1">
                            <input name="productid_hidden" type="hidden"  value="{{$value->product_id}}" />
                            <div class="input-group-btn">
                                
                            </div>
                        </div>
                        <input type="button" class="btn btn-primary px-3 add-to-cart" value=" Add To Cart" data-id_product="{{$value->product_id}}" name="add-to-cart"></input>
                    </div>
                    </form>
            ...
            <div  class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{URL::to('uploads/backend/product/'.$value->product_image)}}" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="{{ URL::to('/chi-tiet-san-pham/'.$value->product_id) }}"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="{{ URL::to('/chi-tiet-san-pham/'.$value->product_id) }}">{{ $value->product_name }}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>{{number_format( $value->product_price).'VND' }}</h5><h6 class="text-muted ml-2"><del>{{number_format( $value->product_price).'VND' }}</del></h6>
                            </div>
